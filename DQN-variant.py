...
class GraphNet(nn.Module):
    def __init__(self, input_size=8, hidden_size=32, n_head=6, n_gat_head=6, nlayers=4, duel_dqn=True, dropout=0.1):
    ...
    def vanilla_forward(self, feature, package_valid_matrix):
        ...
        value_output = self.outputlayer(hidden_sum).squeeze(-1)
...
if __name__ == '__main__':
    ...
    if not args.test:
        ...
        for _i in range(max_step):
            ...
            if _i % 10 == 0:
                ret = evaluate_batch(eval_net, 0, 200)
