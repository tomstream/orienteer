...
if __name__ == '__main__':
    ...
    parser.add_argument("--gamma", type=float, default=1, help="gamma of Q-learning")
    parser.add_argument("--epsilon", type=float, default=0.90, help="epsilon of Q-learniing")
    parser.add_argument("--max-step", type=int, default=10000000, help='max iteration of q-learning')
    parser.add_argument("--num-env", type=int, default=32, help='#number of batch in the optimization')
    ...
    parser.add_argument("--nhead", type=int, default=8, help='# Transformer head')
    parser.add_argument("--n-gat-head", type=int, default=8, help='# GAT head')
    parser.add_argument("--nlayer", type=int, default=4, help='#layer')
    parser.add_argument("--package-num", type=int, help='#node')
    parser.add_argument("--time-limit", type=float, help='time limit')
    parser.add_argument("--duel-dqn", action='store_true', help='duel dqn or not')
    parser.add_argument("--double-dqn", action='store_true', help='double dqn or not')
    parser.add_argument("--test", action='store_true', help='greedy test or not')
    parser.add_argument("--func-type", type=str, default='uniform', help='prize distribution')
    parser.add_argument("--fn", type=str, default='')
    parser.add_argument('--path', action='store_true',help='save path')
