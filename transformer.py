...
class MultiheadAttention(Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False, kdim=None, vdim=None, my_scaling=False):
    ...
    Shape:
        ...
        if hasattr(self, '_qkv_same_embed_dim') and self._qkv_same_embed_dim is False:
            return my_functional.multi_head_attention_forward(
