    ...
    while len(beam_list) > 0:
        ...
        for logp, path, done, utility in beam_list:
            ...
            for a, p in prob:
                ...
                # print(path.getResourceNeedTime(package), path.getResourceWorkingTime())
                # input()
                ...
                new_beam_list.append([logp + math.log(p), current_path, current_done, current_utility])
